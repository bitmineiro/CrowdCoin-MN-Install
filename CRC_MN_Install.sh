...
#Prepare the system and download packages required
...
function create_swap() {
 ...
 then
    echo -e "${RED}Server is running with less than 2G of RAM without SWAP, do you want to create a 2G swap file?${NC} [Y/N]"
    read -e ANSWER
    if [ $ANSWER =~ ^[Yy]$ ]
    then
